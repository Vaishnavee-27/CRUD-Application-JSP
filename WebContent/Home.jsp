...
<div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h1 class="title">CRUD APPLICATION</h1>
					<h3 class="title">done by - Vaishnavi Dasare</h3>
					<h3 class="title">done by - Mayuri Narute</h3>
					<h3 class="title">done by - Avinash Ahire</h3>
                </div>
            </div>
        </div>
    </div>
